...
type TBookRepository interface {
	...
	Update(id uuid.UUID, updateData *dtos.BookUpdateRequest) (*model.Book, error)
...
func (r *bookRepository) FindAll(params dtos.BookQueryParams) ([]model.Book, dtos.PaginationMeta, error) {
